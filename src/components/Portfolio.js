    ...
    <div id="portfolio" className='cards'>
      ...
      <div className='cards__container'>
        <div className='cards__wrapper'>
          ...
          <div className='player'> <ReactPlayer url='https://vimeo.com/474757729' width='450px' height='200px' /></div>
        <div className='player'><ReactPlayer url='https://vimeo.com/474758486' width='450px' height='200px' /></div>
        <div className='player'> <ReactPlayer url='https://vimeo.com/474756530' width='450px' height='200px' /></div>
        </div>
